...
module.exports = function (router) {
  ...
  router.post("/design-sprint-11/choose-deadline-answer", function(req, res) {
  ...
  router.post("/design-sprint-11/ip-number-available-answer", function(req, res) {
    //route user to correct journey depending on entity
  ...
  router.post("/design-sprint-11/applicant-yes-no-answer", function(req, res) {
  ...
  router.post("/design-sprint-11/involvement-answer", function(req, res) {
  ...
  router.post("/design-sprint-11/who-for-answer", function(req, res) {
    // get the type of interested party
  ...
  router.post("/design-sprint-11/add-deadline-item-answer", function(req, res) {
  ...
  router.post("/design-sprint-11/choose-deadline-single-answer", function(req, res) {
  ...
  router.post("/design-sprint-11/deadline-items-answer", function(req, res) {
...
router.post("/design-sprint-11/submission-type-routing", function(req, res) {
...
router.post("/design-sprint-11/make-comment-routing", function(req, res) {
...
router.post("/design-sprint-11/upload-files-routing", function(req, res) {
  // route user to upload files and/or make a text representation
...
router.post("/design-sprint-11/sensitive-information-routing", function(req, res) {
  // route user to upload files and/or make a text representation
...
router.post("/design-sprint-11/sensitive-items-routing", function(req, res) {
...
router.post("/design-sprint-11/check-deadline-item-answer", function(req, res) {
...
router.post("/design-sprint-11/change-deadline-items-form-answer", function(req, res) {
...
router.post(`/design-sprint-11/delete-item-answer`, function (req, res) {
...
router.post("/design-sprint-11/show-hide-filters", function(req, res) {
...
//Show hide doc lib filters
router.post("/design-sprint-11/show-hide-filters-2", function(req, res) {
  if(req.session.data['showfilters']=="true"){
    req.session.data['showfilters']="false"
    res.redirect("/design-sprint-11/document-library/index-2");
  }
  else {
    req.session.data['showfilters']="true"
    res.redirect("/design-sprint-11/document-library/index-2");
...
//Show hide doc lib filters
router.post("/design-sprint-11/show-hide-filters-3", function(req, res) {
  if(req.session.data['showfilters']=="true"){
    req.session.data['showfilters']="false"
    res.redirect("/design-sprint-11/document-library/index-3");
  }
  else {
    req.session.data['showfilters']="true"
    res.redirect("/design-sprint-11/document-library/index-3");
...
router.post("/design-sprint-11/show-hide-filters-v1", function(req, res) {
  if(req.session.data['showfilters']=="true"){
    req.session.data['showfilters']="false"
    res.redirect("/design-sprint-11/document-library/index-v1");
  }
  else {
    req.session.data['showfilters']="true"
    res.redirect("/design-sprint-11/document-library/index-v1");
...
router.post("/design-sprint-11/show-hide-filters-v2", function(req, res) {
  if(req.session.data['showfilters']=="true"){
    req.session.data['showfilters']="false"
    res.redirect("/design-sprint-11/document-library/index-v2");
  }
  else {
    req.session.data['showfilters']="true"
    res.redirect("/design-sprint-11/document-library/index-v2");
...
router.post("/design-sprint-11/show-hide-filters-v3", function(req, res) {
  if(req.session.data['showfilters']=="true"){
    req.session.data['showfilters']="false"
    res.redirect("/design-sprint-11/document-library/index-v3");
  }
  else {
    req.session.data['showfilters']="true"
    res.redirect("/design-sprint-11/document-library/index-v3");
...
//Show hide doc lib filters
router.post("/design-sprint-11/clear-filters", function(req, res) {
  req.session.data['filtersapplied'] = "false"
    res.redirect("document-library");
});

//Apply doc lib filters
router.post("/design-sprint-11/apply-filters", function(req, res) {
...
//Apply doc lib filters
router.post("/design-sprint-11/apply-filters-2", function(req, res) {
  req.session.data['filtersapplied'] = "true"
  req.session.data['showfilters'] = "false"
...
//Apply doc lib filters
router.post("/design-sprint-11/apply-filters-3", function(req, res) {
  req.session.data['filtersapplied'] = "true"
  req.session.data['showfilters'] = "false"
  req.session.data['results'] = "true"
    res.redirect("/design-sprint-11/document-library/index-3");
...
//Apply doc lib filters
router.post("/design-sprint-11/apply-filters-v1", function(req, res) {
  req.session.data['filtersapplied'] = "true"
  req.session.data['showfilters'] = "false"
  req.session.data['results'] = "true"
    res.redirect("/design-sprint-11/document-library/index-v1");
...
router.post("/design-sprint-11/apply-filters-v2", function(req, res) {
  req.session.data['filtersapplied'] = "true"
  req.session.data['showfilters'] = "false"
  req.session.data['results'] = "true"
    res.redirect("/design-sprint-11/document-library/index-v2");
...
router.post("/design-sprint-11/apply-filters-v3", function(req, res) {
  req.session.data['filtersapplied'] = "true"
  req.session.data['showfilters'] = "false"
  req.session.data['results'] = "true"
    res.redirect("/design-sprint-11/document-library/index-v3");
...
router.post("/design-sprint-11/reps-show-hide-filters", function(req, res) {
...
//Apply rep filters
router.post("/design-sprint-11/apply-rep-filters", function(req, res) {
...
router.get("/design-sprint-11/rep-filter-start", function(req, res) {
req.session.data['showrepfilters']="true" ;
req.session.data['repfilterlabel']="Hide" ;
  res.redirect("relevant-representations/index");
...
//
router.get("/design-sprint-11/accordion", function(req, res) {
  ...
  req.session.data['accordion-default-content-2'] = "false";
    ...
    res.redirect("/design-sprint-11/timetable/timetable-upcoming-first-accordion");


});


router.get('/design-sprint-11/start', function (req, res) {
...
res.render("design-sprint-11/start");
})



router.get('/design-sprint-11/timetable/timetableload', function (req, res) {
...
res.redirect('/design-sprint-11/timetable/timetable');
})
// end of timetable data stuff


// reg form
router.post("/design-sprint-11/register/type-of-party", function (req, res) {
  // get the type of interested party
...
router.post(
  "/design-sprint-11/register/on-behalf/representing-who",
  function (req, res) {
    // get the type of interested party
...
router.get("/design-sprint-11/get-updates/unsubscribe-answer",
  function (req, res) {
