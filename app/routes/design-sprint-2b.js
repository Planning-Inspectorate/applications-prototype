...
module.exports = function (router) {
  ...
  router.post("/design-sprint-2b/choose-deadline-answer", function(req, res) {
  ...
  router.post("/design-sprint-2b/ip-number-available-answer", function(req, res) {
    //route user to correct journey depending on entity
  ...
  router.post("/design-sprint-2b/applicant-yes-no-answer", function(req, res) {
  ...
  router.post("/design-sprint-2b/involvement-answer", function(req, res) {
  ...
  router.post("/design-sprint-2b/who-for-answer", function(req, res) {
    // get the type of interested party
  ...
  router.post("/design-sprint-2b/add-deadline-item-answer", function(req, res) {
  ...
  router.post("/design-sprint-2b/deadline-items-answer", function(req, res) {
...
router.post("/design-sprint-2b/submission-type-routing", function(req, res) {
...
router.post("/design-sprint-2b/make-comment-routing", function(req, res) {
...
router.post("/design-sprint-2b/upload-files-routing", function(req, res) {
  // route user to upload files and/or make a text representation
...
router.post("/design-sprint-2b/sensitive-information-routing", function(req, res) {
  // route user to upload files and/or make a text representation
...
router.post("/design-sprint-2b/sensitive-items-routing", function(req, res) {
...
router.post("/design-sprint-2b/check-deadline-item-answer", function(req, res) {
...
router.post("/design-sprint-2b/change-deadline-items-form-answer", function(req, res) {
...
router.post(`/design-sprint-2b/delete-item-answer`, function (req, res) {
...
router.get('/design-sprint-2b/start', function (req, res) {
...
res.render("design-sprint-2b/start");
})



router.get('/design-sprint-2b/timetable/timetableload', function (req, res) {
...
res.redirect('/design-sprint-2b/timetable/timetable');
})
