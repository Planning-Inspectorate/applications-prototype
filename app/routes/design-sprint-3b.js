...
module.exports = function (router) {
  ...
  router.post("/design-sprint-3b/choose-deadline-answer", function(req, res) {
  ...
  router.post("/design-sprint-3b/ip-number-available-answer", function(req, res) {
    //route user to correct journey depending on entity
  ...
  router.post("/design-sprint-3b/applicant-yes-no-answer", function(req, res) {
  ...
  router.post("/design-sprint-3b/involvement-answer", function(req, res) {
  ...
  router.post("/design-sprint-3b/who-for-answer", function(req, res) {
    // get the type of interested party
  ...
  router.post("/design-sprint-3b/add-deadline-item-answer", function(req, res) {
  ...
  router.post("/design-sprint-3b/deadline-items-answer", function(req, res) {
...
router.post("/design-sprint-3b/submission-type-routing", function(req, res) {
...
router.post("/design-sprint-3b/make-comment-routing", function(req, res) {
...
router.post("/design-sprint-3b/upload-files-routing", function(req, res) {
  // route user to upload files and/or make a text representation
...
router.post("/design-sprint-3b/sensitive-information-routing", function(req, res) {
  // route user to upload files and/or make a text representation
...
router.post("/design-sprint-3b/sensitive-items-routing", function(req, res) {
...
router.post("/design-sprint-3b/check-deadline-item-answer", function(req, res) {
...
router.post("/design-sprint-3b/change-deadline-items-form-answer", function(req, res) {
...
router.post(`/design-sprint-3b/delete-item-answer`, function (req, res) {
...
router.post("/design-sprint-3b/show-hide-filters", function(req, res) {
...
//Show hide doc lib filters
router.post("/design-sprint-3b/show-hide-filters-2", function(req, res) {
  if(req.session.data['showfilters']=="true"){
    req.session.data['showfilters']="false"
    res.redirect("/design-sprint-3b/document-library/index-2");
  }
  else {
    req.session.data['showfilters']="true"
    res.redirect("/design-sprint-3b/document-library/index-2");
...
//Show hide doc lib filters
router.post("/design-sprint-3b/show-hide-filters-3", function(req, res) {
  if(req.session.data['showfilters']=="true"){
    req.session.data['showfilters']="false"
    res.redirect("/design-sprint-3b/document-library/index-3");
  }
  else {
    req.session.data['showfilters']="true"
    res.redirect("/design-sprint-3b/document-library/index-3");
...
//Show hide doc lib filters
router.post("/design-sprint-3b/clear-filters", function(req, res) {
  req.session.data['filtersapplied'] = "false"
    res.redirect("document-library");
});

//Apply doc lib filters
router.post("/design-sprint-3b/apply-filters", function(req, res) {
...
//Apply doc lib filters
router.post("/design-sprint-3b/apply-filters-2", function(req, res) {
  req.session.data['filtersapplied'] = "true"
  req.session.data['showfilters'] = "false"
...
//Apply doc lib filters
router.post("/design-sprint-3b/apply-filters-3", function(req, res) {
  req.session.data['filtersapplied'] = "true"
  req.session.data['showfilters'] = "false"
  req.session.data['results'] = "true"
    res.redirect("/design-sprint-3b/document-library/index-3");
...
//
router.get("/design-sprint-3b/accordion", function(req, res) {
  ...
  req.session.data['accordion-default-content-2'] = "false";
    ...
    res.redirect("/design-sprint-3b/timetable/timetable-upcoming-first-accordion");


});


router.get('/design-sprint-3b/start', function (req, res) {

req.session.data['projectname'] = "Drax Bioenergy with Carbon Capture and Storage Project" ;
req.session.data['deadline'] = "Deadline 10"
...
res.render("design-sprint-3b/start");
})



router.get('/design-sprint-3b/timetable/timetableload', function (req, res) {
...
res.redirect('/design-sprint-3b/timetable/timetable');
})
