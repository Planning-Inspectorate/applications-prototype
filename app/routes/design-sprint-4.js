...
module.exports = function (router) {
  ...
  router.post("/design-sprint-4/choose-deadline-answer", function(req, res) {
  ...
  router.post("/design-sprint-4/ip-number-available-answer", function(req, res) {
    //route user to correct journey depending on entity
  ...
  router.post("/design-sprint-4/applicant-yes-no-answer", function(req, res) {
  ...
  router.post("/design-sprint-4/involvement-answer", function(req, res) {
  ...
  router.post("/design-sprint-4/who-for-answer", function(req, res) {
    // get the type of interested party
  ...
  router.post("/design-sprint-4/add-deadline-item-answer", function(req, res) {
...
router.post("/design-sprint-4/submission-type-routing", function(req, res) {
...
router.post("/design-sprint-4/make-comment-routing", function(req, res) {
...
router.post("/design-sprint-4/upload-files-routing", function(req, res) {
  // route user to upload files and/or make a text representation
...
router.post("/design-sprint-4/sensitive-information-routing", function(req, res) {
  // route user to upload files and/or make a text representation
...
router.post("/design-sprint-4/sensitive-items-routing", function(req, res) {
...
router.post("/design-sprint-4/check-deadline-item-answer", function(req, res) {
...
router.post("/design-sprint-4/change-deadline-items-form-answer", function(req, res) {
...
router.post(`/design-sprint-4/delete-item-answer`, function (req, res) {
...
router.post("/design-sprint-4/show-hide-filters", function(req, res) {
...
//Show hide doc lib filters
router.post("/design-sprint-4/show-hide-filters-2", function(req, res) {
  if(req.session.data['showfilters']=="true"){
    req.session.data['showfilters']="false"
    res.redirect("/design-sprint-4/document-library/index-2");
  }
  else {
    req.session.data['showfilters']="true"
    res.redirect("/design-sprint-4/document-library/index-2");
...
router.post("/design-sprint-4/apply-filters", function(req, res) {
...
//Apply doc lib filters
router.post("/design-sprint-4/apply-filters-2", function(req, res) {
  req.session.data['filtersapplied'] = "true"
  req.session.data['showfilters'] = "false"
...
//Apply doc lib filters
router.post("/design-sprint-4/apply-filters-3", function(req, res) {
  req.session.data['filtersapplied'] = "true"
  req.session.data['showfilters'] = "false"
  req.session.data['results'] = "true"
    res.redirect("/design-sprint-4/document-library/index-3");
...
//
router.get("/design-sprint-4/accordion", function(req, res) {
  ...
  req.session.data['accordion-default-content-2'] = "false";
    ...
    res.redirect("/design-sprint-4/timetable/timetable-upcoming-first-accordion");


});


router.get('/design-sprint-4/start', function (req, res) {
...
res.render("design-sprint-4/start");
})



router.get('/design-sprint-4/timetable/timetableload', function (req, res) {
...
res.redirect('/design-sprint-4/timetable/timetable');
})
